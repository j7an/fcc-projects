...
function myReplace(str, before, after) {
  if (before.charAt(0) === before.charAt(0).toUpperCase()) { // checks if capitalized
    after = after.charAt(0).toUpperCase() + after.slice(1); // capitalize and joins remaining chars
  }
  str = str.replace(before, after); // replace substring
  return str;
}
